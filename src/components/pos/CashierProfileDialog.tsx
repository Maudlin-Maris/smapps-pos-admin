...
export default function CashierProfileDialog({ open, onClose }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) { resetForms(); onClose(); } }}>
        ...
        <div className="space-y-4">
          ...
          {!showPasswordForm ? (
            ...
            <div className="space-y-3 rounded-lg border border-border p-3">
              ...
              <div className="flex gap-2">
                <Button variant="ghost" size="sm" className="flex-1" onClick={() => { setShowPasswordForm(false); setCurrentPassword(""); setNewPassword(""); setConfirmPassword(""); }}>
                  Cancel
                </Button>
                <Button size="sm" className="flex-1" onClick={handleChangePassword}>
                  Update Password
                </Button>
              </div>
            </div>
          ...
          {!showPinForm ? (
            ...
            <div className="space-y-3 rounded-lg border border-border p-3">
              ...
              <div className="flex gap-2">
                <Button variant="ghost" size="sm" className="flex-1" onClick={() => { setShowPinForm(false); setCurrentPin(""); setNewPin(""); setConfirmPin(""); }}>
                  Cancel
                </Button>
                <Button size="sm" className="flex-1" onClick={handleChangePin}>
                  Update PIN
                </Button>
              </div>
            </div>
