...
export default function CashierFormDialog({
  ...
  useEffect(() => {
    if (open) {
      ...
      data.assignments.forEach((a) => {
        deptMap[a.outletId] = a.department;
      });
  ...
  const setDepartment = (outletId: string, dept: string) => {
    setDepartmentMap((prev) => ({ ...prev, [outletId]: dept }));
  };
        ...
        <div className="space-y-6 py-2">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Select one or more outlets, then assign a department for each.
            </p>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      {isChecked && departmentMap[outlet.id] && (
                        <Badge variant="secondary" className="text-xs gap-1">
                          ...
                          <button
                            onClick={() => setDepartment(outlet.id, "")}
                    ...
                    {isChecked && departments.length > 0 && (
                      <div className="mt-2 ml-7">
                        <Select
                          value={departmentMap[outlet.id] || ""}
                          onValueChange={(v) => setDepartment(outlet.id, v)}
                        >
