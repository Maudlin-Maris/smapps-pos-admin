...
export const initialReportTransactions: Transaction[] = [
  ...
  { orderId: "ORD-1002", date: "2026-03-08 09:28", customerPhone: "+233 20 555 7788", amount: "₦128.00", cashier: "Kofi B.", location: "Mall Food Court", outletAddress: "Accra Mall, 1st Floor", paymentStatus: "Paid", payments: [{ method: "Card", amount: "₦128.00" }], orderStatus: "Completed", customerName: "Kojo Antwi", orderType: "dine_in", tableLabel: "Table 7", notes: "Allergy: peanuts", subtotal: "₦124.00", fees: [{ name: "Service Charge (5%)", amount: "₦6.20" }], discount: "₦5.00", discountName: "Lunch Combo", tip: "₦2.80", paidAmount: "₦128.00", loyalty: { customerName: "Kojo Antwi", tier: "Gold", rewardName: "₦5 off Lunch Combo", discountValue: "₦5.00", pointsUsed: 50, pointsEarned: 24, pointsBalance: 1280 }, items: [{ name: "Grilled Chicken Combo", qty: 2, unitPrice: "₦45.00", total: "₦90.00", variantName: "Spicy", variantReason: "Customer prefers extra heat", extras: [{ name: "Extra Sauce", qty: 1, price: "₦2.00", reason: "Customer request" }, { name: "Cheese", qty: 2, price: "₦3.00", reason: "Upsell accepted" }], notes: "No peanuts — allergy", modifications: [{ at: "09:28:14", by: "Kofi B.", type: "added", description: "Added 1× Grilled Chicken Combo (Spicy)" }, { at: "09:28:42", by: "Kofi B.", type: "extra", description: "Added Extra Sauce ×1 (+₦2.00)", reason: "Customer request" }, { at: "09:29:05", by: "Kofi B.", type: "extra", description: "Added Cheese ×2 (+₦6.00)", reason: "Upsell accepted" }, { at: "09:29:30", by: "Kofi B.", type: "qty", description: "Quantity changed 1 → 2" }, { at: "09:29:48", by: "Kofi B.", type: "note", description: "Note added: No peanuts — allergy", reason: "Customer allergy disclosed" }] }, { name: "Fresh Juice", qty: 2, unitPrice: "₦12.00", total: "₦24.00", variantName: "Pineapple", variantReason: "Mango out of stock", modifications: [{ at: "09:30:10", by: "Kofi B.", type: "variant", description: "Variant changed Mango → Pineapple", reason: "Mango out of stock" }, { at: "09:30:22", by: "Kofi B.", type: "qty", description: "Quantity changed 1 → 2" }] }, { name: "Side Salad", qty: 2, unitPrice: "₦5.00", total: "₦10.00" }] },
  ...
  { orderId: "ORD-1010", date: "2026-03-08 11:40", customerPhone: "+233 55 111 4455", amount: "₦76.50", cashier: "Kofi B.", location: "Mall Food Court", paymentStatus: "Paid", payments: [{ method: "Cash", amount: "₦80.00" }], orderStatus: "Completed", subtotal: "₦76.50", paidAmount: "₦80.00", changeDue: "₦3.50", items: [{ name: "Burger Meal", qty: 1, unitPrice: "₦42.00", total: "₦42.00", extras: [{ name: "Bacon", qty: 1, price: "₦4.00", reason: "Customer add-on" }, { name: "Extra Cheese", qty: 1, price: "₦2.00", reason: "Upsell accepted" }], modifications: [{ at: "11:40:05", by: "Kofi B.", type: "added", description: "Added 1× Burger Meal" }, { at: "11:40:31", by: "Kofi B.", type: "extra", description: "Added Bacon ×1 (+₦4.00)", reason: "Customer add-on" }, { at: "11:40:48", by: "Kofi B.", type: "extra", description: "Added Extra Cheese ×1 (+₦2.00)", reason: "Upsell accepted" }] }, { name: "Fries - Large", qty: 1, unitPrice: "₦18.50", total: "₦18.50", modifications: [{ at: "11:41:02", by: "Kofi B.", type: "added", description: "Added 1× Fries" }, { at: "11:41:15", by: "Kofi B.", type: "variant", description: "Size upgraded Regular → Large (+₦3.50)", reason: "Customer requested upsize" }] }, { name: "Milkshake", qty: 1, unitPrice: "₦10.00", total: "₦10.00", variantName: "Vanilla", variantReason: "Chocolate temporarily unavailable", modifications: [{ at: "11:41:40", by: "Kofi B.", type: "variant", description: "Variant changed Chocolate → Vanilla", reason: "Chocolate temporarily unavailable" }] }] },
