...
export const sampleMenuItems: MenuItem[] = [
  {
    ...
    sku: "JR-001", status: "active", images: [], variants: [], extras: [], trackInventory: true,
  },
  {
    ...
    sku: "GC-001", status: "active", images: [], variants: [], extras: [], trackInventory: true,
  },
  {
    ...
    sku: "CH-001", status: "active", images: [], variants: [], extras: [], trackInventory: false,
  },
  {
    ...
    sku: "PS-001", status: "active", images: [], variants: [], extras: [], trackInventory: true,
  },
  {
    ...
    sku: "SC-001", status: "active", images: [], variants: [], extras: [], trackInventory: true,
  },
  {
    ...
    sku: "ZD-001", status: "active", images: [], variants: [], extras: [], trackInventory: false,
  },
  {
    ...
    sku: "FR-001", status: "active", images: [], variants: [], extras: [], trackInventory: true,
  },
  {
    ...
    sku: "SY-001", status: "active", images: [], variants: [], extras: [], trackInventory: true,
  },
];
